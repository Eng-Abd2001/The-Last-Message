/**
 * The Last Argument - Core Logic
 * Fully refactored for stability, responsive logic, and strict state management.
 */
...
const ALL_CASES = [
    {
        ...
        spots: [
            { id: "s1", name: "النافذة", x: 25, y: 35, icon: "🪟", ev: { id: "e1_1", name: "زجاج مكسور", desc: "شظايا الزجاج متناثرة خارج المكتب، مما يعني أن الكسر تم من الداخل.", strength: "strong" } },
            { id: "s2", name: "المكتب", x: 65, y: 55, icon: "🗄️", ev: { id: "e1_2", name: "إيصال قهوة", desc: "إيصال بتاريخ وقت الجريمة يحمل اسم المتهم.", strength: "weak" } },
            { id: "s3", name: "الباب", x: 85, y: 75, icon: "🚪", ev: { id: "e1_3", name: "قفل سليم", desc: "الباب لم يُكسر.", strength: "weak" } }
        ],
        courtScript: [
    ...
    },
    {
        ...
        spots: [
            { id: "s1", name: "آلة القهوة", x: 75, y: 25, icon: "☕", ev: { id: "e2_1", name: "بقايا القهوة", desc: "القهوة في الآلة سليمة ولا تحتوي على سم.", strength: "weak" } },
            { id: "s2", name: "مكتب الضحية", x: 35, y: 65, icon: "🔬", ev: { id: "e2_2", name: "كوب الضحية", desc: "الكوب نظيف من الخارج ولكنه يحتوي على آثار سم بالداخل.", strength: "strong" } },
            { id: "s3", name: "خزانة الأدوية", x: 15, y: 35, icon: "💊", ev: { id: "e2_3", name: "دواء السكر", desc: "علبة محليات صناعية تخص الضحية ملوثة بالسم.", strength: "strong" } }
        ],
        courtScript: [
    ...
    },
    {
        ...
        spots: [
            { id: "s1", name: "الباب", x: 50, y: 75, icon: "🚪", ev: { id: "e3_1", name: "قفل الباب", desc: "قفل قديم يمكن إغلاقه من الخارج باستخدام خيط يسحب المفتاح.", strength: "strong" } },
            { id: "s2", name: "النافذة", x: 25, y: 35, icon: "🪟", ev: { id: "e3_2", name: "غبار كثيف", desc: "النافذة لم تفتح منذ شهور.", strength: "weak" } },
            { id: "s3", name: "الأرضية", x: 75, y: 65, icon: "🧶", ev: { id: "e3_3", name: "خيط رفيع", desc: "قطعة من خيط صيد قوي وجدت تحت عقب الباب.", strength: "strong" } }
        ],
        courtScript: [
        ...
        finalArgument: { text: "كيف تثبت تورط صاحب الفندق؟", options: [ { text: "يمتلك نسخة مفاتيح أخرى.", correct: false, resultText: "لقد أثبت للتو أن المفتاح الأساسي استُخدم بالخيط!" }, { text: "هو الوحيد الذي يمتلك خيوط الصيد في الفندق لكونه صياداً.", correct: true, resultText: "دقة ملاحظة مذهلة! تم الإيقاع بالقاتل." } ] }
    },
    {
        ...
        spots: [
            { id: "s1", name: "المكتب", x: 45, y: 45, icon: "📜", ev: { id: "e4_1", name: "الوصية", desc: "مكتوبة بقلم حبر جاف أزرق ومؤرخة قبل 5 سنوات.", strength: "strong" } },
            { id: "s2", name: "الدرج", x: 65, y: 65, icon: "🖋️", ev: { id: "e4_2", name: "قلم حبر سائل", desc: "قلم الضحية المفضل، يستخدم حبراً سائلاً أسود.", strength: "weak" } },
            { id: "s3", name: "التقويم", x: 80, y: 25, icon: "📅", ev: { id: "e4_3", name: "تقرير طبي", desc: "الضحية أصيب بالشلل في يده اليمنى قبل 6 سنوات.", strength: "strong" } }
        ],
        courtScript: [
        ...
        finalArgument: { text: "إذن من زور الوصية؟", options: [ { text: "الشاهد (المحامي) الذي زعم رؤيته.", correct: true, resultText: "تم كشف المحامي والابن الأصغر. براءة للمظلومين." }, { text: "الابن الأصغر كتبها بنفسه.", correct: false, resultText: "الابن لا يجيد تقليد الخط، المحامي هو المزور." } ] }
    },
    {
        id: 5, title: "حادث منتصف الليل", description: "سيارة صدمت الضحية وهربت. المتهم يمتلك سيارة مطابقة.", accused: "سائق متهور", victim: "عابر سبيل", location: "الشارع المظلم",
        spots: [
            { id: "s1", name: "موقع الحادث", x: 35, y: 75, icon: "🚗", ev: { id: "e5_1", name: "طلاء أحمر", desc: "آثار طلاء أحمر من السيارة الصادمة على عمود الإنارة.", strength: "strong" } },
            { id: "s2", name: "سيارة المتهم", x: 75, y: 45, icon: "🚙", ev: { id: "e5_2", name: "صدمة أمامية", desc: "سيارة المتهم (حمراء) بها صدمة من الأمام.", strength: "weak" } },
            { id: "s3", name: "كاميرا المراقبة", x: 55, y: 25, icon: "🎥", ev: { id: "e5_3", name: "تسجيل مشوش", desc: "يظهر سيارة مسرعة بدون لوحات، والمصابيح الأمامية سليمة.", strength: "strong" } }
        ],
        courtScript: [
        ...
        finalArgument: { text: "بماذا تفسر الصدمة في سيارة المتهم؟", options: [ { text: "صدمة قديمة لا علاقة لها بالحادث.", correct: true, resultText: "تمت تبرئة المتهم بنجاح." }, { text: "الشرطة حطمت سيارته.", correct: false, resultText: "حجة سخيفة أغضبت القاضي." } ] }
    },
    {
        ...
        spots: [
            { id: "s1", name: "السجل", x: 50, y: 55, icon: "💻", ev: { id: "e6_1", name: "وقت الدخول", desc: "تم الاختراق الساعة 2 صباحاً من حساب علي.", strength: "strong" } },
            { id: "s2", name: "بوابة الشركة", x: 85, y: 85, icon: "🚪", ev: { id: "e6_2", name: "سجل البوابة", desc: "علي غادر المبنى الساعة 8 مساءً.", strength: "weak" } },
            { id: "s3", name: "شبكة واي فاي", x: 25, y: 25, icon: "📶", ev: { id: "e6_3", name: "سجل الشبكة", desc: "الاختراق تم من جهاز متصل بشبكة الشركة الداخلية حصراً.", strength: "strong" } }
        ],
        courtScript: [
    ...
    },
    {
        ...
        spots: [
            { id: "s1", name: "الجدار", x: 50, y: 35, icon: "🖼️", ev: { id: "e7_1", name: "إطار فارغ", desc: "اللوحة قُطعت من الإطار بآلة حادة.", strength: "weak" } },
            { id: "s2", name: "المنبه", x: 25, y: 75, icon: "🚨", ev: { id: "e7_2", name: "سجل الإنذار", desc: "الإنذار تم تعطيله الساعة 11 مساءً بكلمة سر صحيحة.", strength: "strong" } },
            { id: "s3", name: "جدول الحرس", x: 85, y: 55, icon: "📋", ev: { id: "e7_3", name: "وردية الحارس", desc: "المتهم بدأ ورديته الساعة 12 منتصف الليل.", strength: "strong" } }
        ],
        courtScript: [
    ...
    },
    {
        ...
        spots: [
            { id: "s1", name: "المسدس", x: 50, y: 55, icon: "🔫", ev: { id: "e8_1", name: "مسدس حقيقي", desc: "وزنه ثقيل ومحشو برصاص حي.", strength: "strong" } },
            { id: "s2", name: "خزانة", x: 25, y: 45, icon: "📦", ev: { id: "e8_2", name: "مسدس مزيف", desc: "وزنه خفيف جداً ومصنوع من البلاستيك.", strength: "weak" } },
            { id: "s3", name: "كاميرا", x: 80, y: 25, icon: "📹", ev: { id: "e8_3", name: "فيديو", desc: "المتهم يظهر وهو يحمل المسدس ويتذمر من ثقله المفاجئ.", strength: "strong" } }
        ],
        courtScript: [
    ...
    },
    {
        ...
        spots: [
            { id: "s1", name: "الزجاج", x: 45, y: 65, icon: "🔍", ev: { id: "e9_1", name: "بصمات", desc: "بصمات يد يمنى فقط على واجهة العرض.", strength: "strong" } },
            { id: "s2", name: "الخزنة", x: 75, y: 45, icon: "🔒", ev: { id: "e9_2", name: "مقبض الخزنة", desc: "تم لفه بقوة باستخدام اليد اليمنى.", strength: "strong" } },
            { id: "s3", name: "ملف طبي", x: 25, y: 85, icon: "📄", ev: { id: "e9_3", name: "تقرير طبي", desc: "المتهم كريم يستخدم يده اليسرى بشكل حصري (أعسر).", strength: "weak" } }
        ],
        courtScript: [
    ...
    {
        id: 10, title: "الفساد الأخير", description: "عمدة المدينة متهم بتلقي رشاوي. المحكمة منحازة.", accused: "الصحفي الاستقصائي", victim: "العمدة", location: "مكتب العمدة",
        spots: [
            { id: "s1", name: "درج العمدة", x: 55, y: 55, icon: "🗄️", ev: { id: "e10_1", name: "ظرف نقود", desc: "ظرف فارغ يحمل ختم بنك أجنبي.", strength: "weak" } },
            { id: "s2", name: "تسجيل", x: 35, y: 35, icon: "📼", ev: { id: "e10_2", name: "شريط صوتي", desc: "تسجيل للعمدة يطلب تحويل الأموال لحساب سويسري.", strength: "strong" } },
            { id: "s3", name: "سلة", x: 85, y: 85, icon: "🗑️", ev: { id: "e10_3", name: "تذكرة", desc: "تذكرة سفر لسويسرا باسم العمدة بتارخ الغد.", strength: "strong" } }
        ],
        courtScript: [
            { speaker: "judge", text: "أيها الصحفي، أنت متهم بتلفيق التهم للعمدة." },
...
const ACHIEVEMENTS_DATA = [
    ...
    { id: "genius", title: "المحقق العبقري", desc: "اجمع كل الأدلة في قضية." },
    { id: "flawless", title: "قلب القضية", desc: "اربح قضية بدون أخطاء." },
...
let state = {
    ...
    isProcessingLogic: false // Prevents double clicking
};
...
function saveGame() {
    try {
        localStorage.setItem('lastArgumentSave_v2', JSON.stringify({
...
function loadGame() {
    try {
        const saved = localStorage.getItem('lastArgumentSave_v2');
        if(saved) {
...
function grantAchievement(id) {
    ...
    t.innerHTML = `<div class="ach-icon">🏆</div><div class="ach-text"><h4>إنجاز: ${ach.title}</h4><p>${ach.desc}</p></div>`;
    container.appendChild(t);
    setTimeout(() => {
        t.style.animation = "slideDown 0.4s ease reverse forwards";
...
function renderCases() {
    ...
    ALL_CASES.forEach(c => {
        ...
        card.innerHTML = `
            ...
            <p>${isLocked ? '🔒 ملف مغلق يتطلب حل القضايا السابقة' : c.description}</p>
            ${isSolved ? '<span class="case-status">✓ محسومة</span>' : ''}
        `;
        if(!isLocked) {
            card.onclick = () => startInvestigation(c.id);
        }
...
function startInvestigation(caseId) {
    ...
    showToast("ابحث في مسرح الجريمة، انقر على الدوائر لجمع الأدلة.");
}
...
function collectEvidence(spot, el) {
    ...
    if(state.inventory.length === c.spots.length) {
        ...
        showToast("اكتملت الأدلة! توجه للمحكمة.");
...
function processCourtDialogue() {
    ...
    if(step.type === 'present') {
        ...
        appendChat('judge', 'القاضي', 'هل لديك دليل يكشف تناقض هذه الشهادة؟');
    } else {
...
function presentEvidence(ev) {
    ...
    if(ev.id === step.correctEv) {
        playSound('objection');
        appendChat('lawyer', 'أنت (المحامي)', `اعتراض! الدليل "${ev.name}" يثبت العكس: ${step.successMsg}`);
        ...
        appendChat('lawyer', 'أنت (المحامي)', `سيدي القاضي، انظر إلى "${ev.name}"...`);
        ...
        setTimeout(() => {
            ...
            if(state.attemptsLeft <= 0) {
                setTimeout(() => finishCase(false, "تم طردك من القاعة بسبب تقديم أدلة غير منطقية بشكل متكرر. القضية خُسرت."), 2000);
            } else {
                setTimeout(() => {
...
function finishCase(isWin, desc) {
    ...
    titleEl.innerText = isWin ? "القضية محسومة - نجاح" : "خسارة القضية";
    titleEl.style.color = isWin ? "var(--success)" : "var(--danger)";
    document.getElementById('result-icon').innerText = isWin ? "⚖️" : "⛓️";
    document.getElementById('result-desc').innerText = desc;
    
    document.getElementById('result-stats-details').innerHTML = `
        <p>القضايا المحلولة: <strong class="gold-text">${state.solvedCases.length} / ${ALL_CASES.length}</strong></p>
        <p>تقييم الأداء: <strong>${state.perfectCurrentCase && isWin ? 'مثالي ⭐⭐⭐' : (isWin ? 'جيد ⭐⭐' : 'سيء ❌')}</strong></p>
    `;
    ...
    ACHIEVEMENTS_DATA.forEach(a => {
        ...
        achList.innerHTML += `
            <div class="ach-item ${unlocked ? 'unlocked' : ''}">
                ...
                <div>
                    <h4 style="color:${unlocked?'var(--gold)':'var(--text-dim)'}; margin-bottom:4px;">${a.title}</h4>
                    <p style="font-size:0.75rem; color:var(--text-dim);">${unlocked ? a.desc : '؟؟؟'}</p>
                </div>
            </div>
        `;
    });
...
function shareStats() {
    if(navigator.share) {
        navigator.share({
            ...
            text: `لعبت "المحامي الأخير"! حليت ${state.solvedCases.length} قضايا ولدي ${state.stats.perfectCases} مرافعة مثالية. هل يمكنك كشف الحقيقة؟`,
